...
import { VaccineInterface } from '../interface/vaccine.interface';

@Injectable()
export class VaccineRepository {
  constructor(
    @InjectModel(configs.covid.mongoSchemaName)
    private readonly vaccineCollection: Model<VaccineInterface>,
  ) {}

  // async save() {}
  // async remove() {}

  async getVaccineSummaryResult(
    country?: string,
    dateFrom?: string,
    dateTo?: string,
    sort?: object,
